...
waste_collection_18.by_codes2 <- waste_collection_18.by_codes2 |> 
  mutate(
    collected_from = case_when(
      collected_from == "1-izvirni povzročitelj:prepuščeno" ~ "other producer: handed over",
      collected_from == "2-izvirni povzročitelj:oddano" ~ "other producer: given",
      collected_from == "3-drug zbiralec" ~ "other collector",
      collected_from == "4-izvajalec obdelave" ~ "processing operator"
    )
  )
