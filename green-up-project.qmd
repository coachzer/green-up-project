...
```{r 2018}
data18_path <- "C:/Users/kovac/Desktop/Green UP Project/green-up-project/2018 data/ODP_2018_objava21122020.xlsx"
```
...
data18.sheet1 <- read_excel(data18_path, skip = 2, sheet = 1)
...
bar_chart.sheet1 <- ggplot(filtered_by_codes.sheet1, aes(x = factor(Region), fill = factor(Region))) +
  geom_bar() +
  labs(title = "WASTE GENERATED by Region", x = "Region", y = "Count") +
  scale_x_discrete(labels = c("1" = "POMURSKA", "2" = "PODRAVSKA", "3" = "KOROŠKA", "4" = "SAVINJSKA", "5" = "ZASAVSKA", "6" = "POSAVSKA", "7" = "JUGOVZHODNA", "8" = "OSREDNJESLOVENSKA", "9" = "GORENJSKA", "10" = "PRIMORSKO-NOTRANJSKA", "11" = "GORIŠKA", "12" = "OBALNO-KRAŠKA"))
...
# Create a pie chart
ggplot(waste_per_company.sheet1, aes(x = "", y = Count, fill = `ŠT. ODPADKA`)) +
...
data18.sheet2 <- read_excel(data18_path, skip = 2, sheet = 2)
...
bar_chart.sheet2 <- ggplot(filtered_by_codes.sheet2, aes(x = factor(Region), fill = factor(Region))) +
  geom_bar() +
