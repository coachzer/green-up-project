...
get_palette <- scales::brewer_pal(type = "qual", palette = 1)
for (region in regions) {
  plot(trajectories[[region]]$generate_waste, fill = get_palette)
  plot(trajectories[[region]]$collect_waste, fill = get_palette)
  plot(trajectories[[region]]$handle_waste, fill = get_palette)
}
