...
packages <- c("tidyverse", "scales", "viridis", "ggplot2", "gganimate", 
              "ggridges", "plotly", "htmlwidgets", "reshape2", "skimr")
...
waste.storage.2020.data <- waste.storage.2020.data |>
    select(statistical_region, type_of_waste, waste_stored_start_year, waste_stored_end_year) |>
    mutate(type_of_waste = clear_waste_name(type_of_waste))
...
names(waste.storage.2018.data) <- colnames(waste.storage.2016.data)
names(waste.storage.2019.data) <- colnames(waste.storage.2016.data)
names(waste.storage.2020.data) <- colnames(waste.storage.2016.data)
...
t24 <- ggplotly(variant_plot, width = 1000, height = 1000, tooltip = "text") 
