...
ggsave("waste_analysis_2023_stacked.png", p1, width = 10, height = 6, dpi = 300)
print("Saved: waste_analysis_2023_stacked.png")
...
ggsave("waste_analysis_2023_percentage.png", p2, width = 10, height = 6, dpi = 300)
print("Saved: waste_analysis_2023_percentage.png")
...
ggsave("waste_analysis_2023_faceted.png", p3, width = 12, height = 8, dpi = 300)
print("Saved: waste_analysis_2023_faceted.png")
...
ggsave("waste_analysis_2024_stacked.png", p4, width = 10, height = 6, dpi = 300)
print("Saved: waste_analysis_2024_stacked.png")
...
ggsave("waste_analysis_2024_percentage.png", p5, width = 10, height = 6, dpi = 300)
print("Saved: waste_analysis_2024_percentage.png")
...
ggsave("waste_analysis_2024_faceted.png", p6, width = 12, height = 8, dpi = 300)
print("Saved: waste_analysis_2024_faceted.png")
...
ggsave("waste_analysis_comparison_totals.png", p7, width = 10, height = 6, dpi = 300)
print("Saved: waste_analysis_comparison_totals.png")
...
ggsave("waste_analysis_comparison_percentages.png", p8, width = 10, height = 6, dpi = 300)
print("Saved: waste_analysis_comparison_percentages.png")
...
ggsave("waste_analysis_comparison_public_service.png", p9, width = 10, height = 6, dpi = 300)
print("Saved: waste_analysis_comparison_public_service.png")
...
# ensure the output dir exists (not tracked in git)
