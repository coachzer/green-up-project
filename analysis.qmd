...
ggplotly(t10, width = 800, height = 500)
...
ggplotly(t11, width = 1000, height = 500)
...
# stacked bar plot
t12 <- ggplot(df_long_collected, aes(x = year, y = total_collected, fill = name_of_municipality)) +
...
ggplotly(t12, width = 800, height = 500)
```
...
```{r collection_combined_data_household_composting}

# household composting only exists from 2020 
household.composting.2020.data <- read_csv("2020 data/2020 filtered/collection/home_composting_20.csv")
household.composting.2021.data <- read_csv("2021 data/2021 filtered/collection/household_composting_21.csv")
