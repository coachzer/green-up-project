...
waste.collected.2020.data <- waste.collected.2020.data |>
  select(year, statistical_region, name_of_municipality, type_of_waste, municipal_waste_collected_by_municipality) |> 
  rename(total_waste_collected = municipal_waste_collected_by_municipality)

waste.collected.2021.data <- waste.collected.2021.data |>
  select(year, statistical_region, name_of_municipality, type_of_waste, waste_by_municipality) |> 
  rename(total_waste_collected = waste_by_municipality)
