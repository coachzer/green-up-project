...
colnames(without_company_data)
colnames(g.2019.data)
colnames(g.2020.data)
colnames(g.2021.data)
colnames(g.2022.data)
colnames(g.2023.data)
...
unique_waste_types <- unique(combined_data$type_of_waste)
print(unique_waste_types)

# get unique waste categories
unique_waste_categories <- unique(combined_data$waste_category)
print(unique_waste_categories)

# get unique statistical regions
unique_statistical_regions <- unique(combined_data$statistical_region)
print(unique_statistical_regions)
